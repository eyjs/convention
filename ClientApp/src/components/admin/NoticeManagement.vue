<template>
  <div>
    ...
    <AdminPageHeader
      title="공지사항 관리"
      description="공지사항을 등록하고 관리할 수 있습니다"
    >
      <AdminButton
        variant="secondary"
        :icon="Settings"
    ...
    <div class="bg-white rounded-lg shadow-sm p-6 mb-6 mt-6">
      <div class="flex gap-4">
        ...
        <AdminButton @click="handleSearch">검색</AdminButton>
      </div>
    </div>
    ...
    <div v-else class="bg-white rounded-lg shadow-sm overflow-hidden">
      <table class="w-full">
        <thead class="bg-gray-50">
          <tr>
            <th
              class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase w-20"
            >
              번호
            </th>
            <th
            ...
            <th
              class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase w-40"
            >
              카테고리
            </th>
            <th
            ...
            <th
              class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase w-24"
            >
              조회
            </th>
            <th
        ...
        <tbody class="divide-y">
          ...
          >
            ...
            <td class="px-6 py-4">
              ...
              >
                <span
                  class="text-sm text-gray-900 font-medium hover:text-primary-600 transition-colors"
                  >{{ notice.title }}</span
                >
...
const fetchCategories = async () => {
  try {
    const response = await categoryAPI.getNoticeCategories(props.conventionId)
