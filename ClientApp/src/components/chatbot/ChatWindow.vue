  ...
  >
    ...
    >
      <div class="flex-shrink-0 bg-white border-b border-gray-200 px-6 py-4">
        <div class="flex items-center justify-between">
          <div class="flex items-center space-x-3">
            <div class="w-10 h-10 rounded-full bg-gradient-to-br from-emerald-400 to-cyan-500 flex items-center justify-center shadow-sm">
      ...
      >
        ...
        >
          <div class="w-20 h-20 mb-6 bg-gradient-to-br from-emerald-400 to-cyan-500 rounded-full flex items-center justify-center shadow-lg">
        ...
        <div v-if="chatStore.loading" class="flex items-start space-x-3 mb-6">
          <div class="w-8 h-8 rounded-full bg-gradient-to-br from-emerald-400 to-cyan-500 flex items-center justify-center shadow-sm flex-shrink-0">
...
const showSuggestions = computed(() => {
  return chatStore.messages.length <= 1 && chatStore.suggestedQuestions.length > 0
})
