    ...
    <template #body>
      <div class="space-y-4">
        ...
        <div
          ...
          class="max-h-64 overflow-y-scroll border rounded-lg"
        >
          <ul>
            <li
              ...
              :class="{
                'bg-blue-50':
                  selectedPlaceForMap && selectedPlaceForMap.id === result.id,
              }"
            ...
            >
              ...
              <p
                v-if="result.phone"
                class="text-gray-600 text-xs mt-1 flex items-center gap-1"
              >
                <svg
                  class="w-3 h-3"
                  fill="none"
        ...
        <p
          v-else-if="searchTerm && !loadingSearch"
        ...
        <div v-if="selectedPlaceForMap">
          <div
            ref="mapContainer"
            class="w-full h-64 rounded-lg shadow-md mt-4"
          ></div>
        </div>
      </div>
    </template>
