...
export const ACTION_CATEGORIES = [
  {
    ...
    description: 'Creates a clickable button in a designated area on a specific page.',
    component: 'GenericButton',
    guide: {
      title: 'Button: 추가 설정 가이드',
      content: '버튼의 세부 동작과 스타일을 JSON으로 설정합니다. `onClick` 객체를 통해 클릭 시 동작을 정의할 수 있습니다.',
  ...
  },
  {
    ...
    description: 'Adds a new item to a menu screen, such as the "More Features" page.',
  ...
  },
  {
    ...
    description: 'Displays a popup that appears automatically based on certain conditions, like user login.',
    component: 'GenericAutoPopup',
    guide: {
      title: 'Auto Popup: 추가 설정 가이드',
      content: '자동 팝업의 내용과 동작 방식을 정의합니다. `showOnce`를 true로 설정하면 사용자가 한 번 닫은 후 다시 보지 않습니다.',
      example: JSON.stringify({ 
        title: "팝업 제목", 
        message: "팝업 메시지",
        buttonText: "버튼 텍스트",
  ...
  },
  {
    ...
    description: 'Displays an informational card with title, description, and optional icon.',
