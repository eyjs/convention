<template>
  <div class="min-h-screen relative bg-gray-50">
    ...
    <div class="fixed inset-0 z-0 overflow-hidden pointer-events-none">
      ...
      <div
        class="absolute -top-32 -left-32 w-80 h-80 bg-gradient-to-br from-rose-200/15 to-orange-200/15 rounded-full blur-3xl"
      ></div>
      <div
        class="absolute top-1/2 -right-40 w-96 h-96 bg-gradient-to-br from-orange-200/12 to-amber-200/12 rounded-full blur-3xl"
      ></div>
      <div
        class="absolute bottom-32 left-1/4 w-72 h-72 bg-gradient-to-br from-amber-200/12 to-rose-200/12 rounded-full blur-3xl"
      ></div>
    ...
    <div class="relative z-10">
      ...
      <div class="max-w-2xl mx-auto px-4 py-4">
        ...
        <div v-if="loading" class="text-center py-16">
          <div
            class="animate-spin rounded-full h-12 w-12 border-b-2 border-rose-600 mx-auto"
          ></div>
        ...
        <template v-else>
          ...
          <div v-if="conventions.length === 0" class="text-center py-16">
            <div
              class="w-24 h-24 mx-auto mb-6 bg-rose-100 rounded-full flex items-center justify-center"
            >
              <svg
          ...
          <div v-else class="space-y-5">
            ...
            >
              ...
              <div class="relative h-40 overflow-hidden">
                ...
                <div
                  v-else
                  class="absolute inset-0 bg-gradient-to-br from-rose-500 via-orange-500 to-amber-500 pointer-events-none"
                >
                  <div
...
async function loadConventions() {
  ...
  try {
    const response = await apiClient.get(
      `/users/conventions?_=${new Date().getTime()}`,
    )
