<template>
  <div
    class="min-h-screen min-h-dvh bg-gradient-to-br from-primary-500 to-primary-700 flex items-center justify-center p-4"
  >
...
const loadConventions = async () => {
  try {
    ...
    conventions.value = response.data.filter(
      (c) => c.deleteYn === 'N' && c.completeYn === 'N',
    )
  } catch (error) {
