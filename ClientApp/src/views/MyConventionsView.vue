        ...
        >
          ...
          >
            <div class="absolute top-3 right-3">
              <span
                v-if="convention.completeYn === 'N'"
                class="px-2 py-1 bg-green-500/80 text-white text-xs rounded-full backdrop-blur-sm"
              >
                진행중
              </span>
              <span
                v-else
                class="px-2 py-1 bg-gray-800/50 text-white text-xs rounded-full backdrop-blur-sm"
              >
                종료
              </span>
            </div>
