                  ...
                  <div class="flex-1 pb-6">
                    <div
                      ...
                      :class="{
                        ...
                        'bg-primary-50 border-primary-200': item.isAutoGenerated,
                    ...
                    >
                      <div class="flex items-start justify-between gap-3">
                        ...
                        <div class="flex-shrink-0 ml-auto flex items-center gap-2">
                            <svg v-if="item.expenseAmount && item.expenseAmount > 0" class="w-5 h-5 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
