...
public interface IAttributeCategoryService
{
    ...
    Task<object> CreateCategoryAsync(int conventionId, string name, string? icon);
    Task<object> UpdateCategoryAsync(int categoryId, string name, string? icon, List<string> attributeKeys);
