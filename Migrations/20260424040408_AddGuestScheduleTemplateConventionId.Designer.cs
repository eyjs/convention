...
namespace LocalRAG.Migrations
{
    ...
    [Migration("20260424040408_AddGuestScheduleTemplateConventionId")]
    partial class AddGuestScheduleTemplateConventionId
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LocalRAG.DTOs.ScheduleModels.GuestScheduleTemplate", b =>
                {
                    ...
                    b.HasKey("UserId", "ScheduleTemplateId", "ConventionId");

                    b.HasIndex("ConventionId")
                        .HasDatabaseName("IX_GuestScheduleTemplate_ConventionId");
            ...
            modelBuilder.Entity("LocalRAG.DTOs.ScheduleModels.ScheduleItem", b =>
                {
                    ...
                    b.Property<string>("VisibleAttributes")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("LocalRAG.Entities.AttributeCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LocalRAG.Entities.AttributeCategoryItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AttributeCategoryItems");
                });
            ...
            modelBuilder.Entity("LocalRAG.Entities.CompanionRelation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ConventionId", "UserId", "CompanionUserId")
                        .IsUnique();

                    b.ToTable("CompanionRelations");
                });
            ...
            modelBuilder.Entity("LocalRAG.Entities.Convention", b =>
                {
                    ...
                    b.Property<string>("MeetingPointInfo")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("LocalRAG.Entities.Flight.IncheonFlightData", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("MasterFlightId")
                        .HasMaxLength(20)
                        .HasColumnType("nvarchar(20)");
                    ...
                    b.HasIndex("FlightId", "ScheduleDate", "FlightType")
                        .HasDatabaseName("IX_IncheonFlightData_FlightId_ScheduleDate_FlightType");

                    b.ToTable("IncheonFlightData");
                });

            modelBuilder.Entity("LocalRAG.Entities.FormBuilder.FormDefinition", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LocalRAG.Entities.FormBuilder.FormField", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LocalRAG.Entities.FormBuilder.FormSubmission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LocalRAG.Entities.HomeBanner", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("DetailImagesJson")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("LocalRAG.Entities.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ConventionId")
                        .HasDatabaseName("IX_Notification_ConventionId");
            ...
            modelBuilder.Entity("LocalRAG.Entities.OptionTour", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ConventionId")
                        .HasDatabaseName("IX_OptionTour_ConventionId");

                    b.HasIndex("Date")
                        .HasDatabaseName("IX_OptionTour_Date");

                    b.HasIndex("ConventionId", "CustomOptionId")
                        .HasDatabaseName("IX_OptionTour_ConventionId_CustomOptionId");

                    b.ToTable("OptionTours");
                });
            ...
            modelBuilder.Entity("LocalRAG.Entities.PersonalTrip.Accommodation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CheckInTime")
                        .HasDatabaseName("IX_Accommodation_CheckInTime");

                    b.HasIndex("PersonalTripId")
                        .HasDatabaseName("IX_Accommodation_PersonalTripId");

                    b.ToTable("Accommodations");
                });

            modelBuilder.Entity("LocalRAG.Entities.PersonalTrip.ChecklistCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PersonalTripId")
                        .HasDatabaseName("IX_ChecklistCategory_PersonalTripId");

                    b.ToTable("ChecklistCategories");
                });

            modelBuilder.Entity("LocalRAG.Entities.PersonalTrip.ChecklistItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ChecklistCategoryId")
                        .HasDatabaseName("IX_ChecklistItem_ChecklistCategoryId");
            ...
            modelBuilder.Entity("LocalRAG.Entities.PersonalTrip.ItineraryItem", b =>
                {
                    ...
                    b.Property<string>("KakaoPlaceUrl")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
            ...
            modelBuilder.Entity("LocalRAG.Entities.PersonalTrip.PersonalTrip", b =>
                {
                    ...
                    b.HasIndex("ShareToken")
                        .IsUnique()
                        .HasDatabaseName("UQ_PersonalTrip_ShareToken")
                        .HasFilter("[ShareToken] IS NOT NULL");

                    b.HasIndex("StartDate")
                        .HasDatabaseName("IX_PersonalTrip_StartDate");

                    b.HasIndex("UserId")
                        .HasDatabaseName("IX_PersonalTrip_UserId");
            ...
            modelBuilder.Entity("LocalRAG.Entities.ScheduleImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LocalRAG.Entities.User", b =>
                {
                    ...
                    b.Property<DateTime?>("PassportVerifiedAt")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("LocalRAG.Entities.UserNotification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("UserId")
                        .HasDatabaseName("IX_UserNotification_UserId");

                    b.HasIndex("UserId", "NotificationId")
                        .IsUnique()
                        .HasDatabaseName("IX_UserNotification_User_Notification");

                    b.ToTable("UserNotifications");
                });

            modelBuilder.Entity("LocalRAG.Entities.UserOptionTour", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ConventionId")
                        .HasDatabaseName("IX_UserOptionTour_ConventionId");

                    b.HasIndex("OptionTourId")
                        .HasDatabaseName("IX_UserOptionTour_OptionTourId");

                    b.HasIndex("UserId")
                        .HasDatabaseName("IX_UserOptionTour_UserId");

                    b.HasIndex("UserId", "ConventionId", "OptionTourId")
                        .IsUnique()
                        .HasDatabaseName("UQ_UserOptionTour_UserId_ConventionId_OptionTourId");

                    b.ToTable("UserOptionTours");
                });
            ...
            modelBuilder.Entity("LocalRAG.Entities.AttributeCategoryItem", b =>
                {
                    b.HasOne("LocalRAG.Entities.AttributeCategory", "AttributeCategory")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("LocalRAG.Entities.CompanionRelation", b =>
                {
                    b.HasOne("LocalRAG.Entities.User", "CompanionUser")
            ...
            modelBuilder.Entity("LocalRAG.Entities.FormBuilder.FormField", b =>
                {
                    b.HasOne("LocalRAG.Entities.FormBuilder.FormDefinition", "FormDefinition")
                        .WithMany("Fields")
            ...
            modelBuilder.Entity("LocalRAG.Entities.Notification", b =>
                {
                    ...
                    b.HasOne("LocalRAG.Entities.User", "SentByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("LocalRAG.Entities.PersonalTrip.ChecklistItem", b =>
                {
                    b.HasOne("LocalRAG.Entities.PersonalTrip.ChecklistCategory", "Category")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("LocalRAG.Entities.QuestionOption", b =>
                {
                    b.HasOne("LocalRAG.Entities.OptionTour", "OptionTour")
                        .WithMany()
                        .HasForeignKey("OptionTourId")
            ...
            modelBuilder.Entity("LocalRAG.Entities.ScheduleImage", b =>
                {
                    ...
                    b.HasOne("LocalRAG.DTOs.ScheduleModels.ScheduleItem", "ScheduleItem")
                        .WithMany("Images")
            ...
            modelBuilder.Entity("LocalRAG.Entities.UserNotification", b =>
                {
                    b.HasOne("LocalRAG.Entities.Notification", "Notification")
