...
public class GuestContextualDataProvider
{
    ...
    /// </summary>
    private void AppendPersonalInfo(StringBuilder sb, Guest guest)
    {
    ...
    /// </summary>
    private void AppendScheduleInfo(StringBuilder sb, Guest guest)
    {
    ...
    /// </summary>
    private void AppendAttributesInfo(StringBuilder sb, Guest guest)
    {
