...
public class ConventionService
{
    ...
    /// 행사 상세 정보를 조회합니다.
    /// </summary>
    public async Task<Convention?> GetConventionDetailsAsync(int conventionId)
    {
    ...
    /// </summary>
    public async Task<Convention> CreateConventionWithOwnersAsync(
    ...
    /// </summary>
    public async Task<bool> UpdateConventionAsync(int conventionId, Convention updatedData)
    {
    ...
    /// - 사용자 경험 개선 (빠른 응답)
    /// </summary>
    public async Task<(IEnumerable<Convention> Items, int TotalCount, int TotalPages)> 
        GetConventionsPagedAsync(int pageNumber, int pageSize, string? conventionType = null)
    {
        // 조건 생성
        System.Linq.Expressions.Expression<Func<Convention, bool>>? predicate = null;
    ...
    /// </summary>
    public async Task<IEnumerable<Guest>> SearchGuestsAsync(
    ...
    /// - 성능 향상
    /// </summary>
    public async Task<int> BulkRegisterGuestsAsync(List<Guest> guests)
    {
        // 기본값 설정
